enum DeviceScreenType {
  ...
  static bool isDesktop({required double width}) => width >= DeviceScreenType.desktop.breakpoint;

  static bool isTablet({required double width}) =>
      width >= DeviceScreenType.tablet.breakpoint &&
      width < DeviceScreenType.desktop.breakpoint;

  static bool isMobile({required double width}) =>
